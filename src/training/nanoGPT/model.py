...
@dataclass
class GPTConfig:
    block_size: int = 256 # max game length aligned to a smaller number divisible by 64 2816
    vocab_size: int = len(tokenizer.all_tokens)
...
class GPT(nn.Module):
    ...
    def get_legal_moves(self, token_idx, tokenizer):
        """
            Given specific token_idx, decodes it and returns a set of legal moves from this position
        """
