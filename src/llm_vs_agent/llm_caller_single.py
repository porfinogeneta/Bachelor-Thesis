...
class LLMCaller:
    ...
    def sample_next_move(self, prev_head: List[Tuple[int, int]], model: str, game_sequence: str, top_k: int = 1) -> str | None:
        """
...
if __name__ == "__main__":
    lm_caller = LLMCaller(model="out-standard_pos")

    sequences = ["<START> S0 R1C8 L0 A87 A12 A19 A44 A26 S1 R8C0 L0 A87 A12 A19 A44 A26 S0 R1C9 L0 A87 A12 A44 A26 A48 S1",
                "<START> S0 R3C6 L0 A54 A23 A35 A87 A12 S1 R4C2 L0 A54 A23 A35 A87 A12 S0 R3C5 L0 A54 A23 A87 A12 A01 S1",
                "<START> S0 R7C4 L0 A81 A60 A85 A66 A45 S1 R8C4 L0 A81 A60 A85 A66 A45 S0 R7C5 L0 A81 A60 A85 A66 A45 S1"]
    lm_caller.sample_next_move(prev_heads=(4, 2), game_sequence="<START> S0 R3C6 L0 A54 A23 A35 A87 A12 S1 R4C2 L0 A54 A23 A35 A87 A12 S0 R3C5 L0 A54 A23 A87 A12 A01 S1")
